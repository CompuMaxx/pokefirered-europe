...
const u8 gText_BattleSwitchWhich[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}Changer\nlequel?");
...
const u8 gText_BattleTowerBan_Is1[] = _("sont");
const u8 gText_BattleTowerBan_Is2[] = _("sont");
const u8 gText_BadEgg[] = _("Mauv. OEUF");
const u8 gText_BattleWallyName[] = _("ミツル");
const u8 gText_Win[] = _("{HIGHLIGHT 0}Victoire");
const u8 gText_Loss[] = _("{HIGHLIGHT 0}Défaite");
const u8 gText_Draw[] = _("{HIGHLIGHT 0}Egalité");
...
const u8 gText_ADarkMove[] = _("une capacité TENEBRES");
const u8 gText_TimeBoard[] = _("TEMPS");
const u8 gText_ClearTime[] = _("TEMPS ECOULE");
